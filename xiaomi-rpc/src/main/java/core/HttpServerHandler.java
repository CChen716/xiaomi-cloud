...
public class HttpServerHandler implements Handler<HttpServerRequest> {
    ...
    public void handle(HttpServerRequest request) {
        ...
        request.bodyHandler(body->{
          ...
          //  SerializeUtils serializeUtils = new SerializeUtils(); 硬编码选择
            //用户自定义配置选择
            Serialize serializeUtils = SerializerFactory.getInstance(RpcConfigApplication.getRpcConfig().getSerialize());
    ...
    //响应方法
    public void doResponse(RpcResponse rpcResponse,HttpServerRequest request,Serialize serializeUtils){
